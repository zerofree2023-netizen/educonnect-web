...
const DATA: Array<[string, string, string, string]> = [
  ...
  ["Biomedical Engineering", "生物医学工程", "Biomedical Engineering", "生物医学工程"],
  ...
  ["Electronic Information", "电子信息", "Biomedical Engineering", "生物医学工程"],
  ["Electronic Information", "电子信息", "Computer Technology", "计算机技术"],
  ["Electronic Information", "电子信息", "Instrumentation Engineering", "仪器仪表工程"],
  ...
  ["Energy and Power", "能源动力", "Energy and Power", "能源动力"],
  ...
  ["Geology", "地质学", "Stratigraphic Paleontology", "古生物学与地层学"],
  ...
  ["Philosophy", "哲学", "Philosophy of Science and Technology", "科学技术哲学"],
  ...
  ["Planetary Science and Exploration Technology", "行星科学与探测技术", "Planetary Science and Exploration Technology", "行星科学与探测技术"],
...
export function parseUstcPhdChineseImagePdf() {
  const rows: UstcPhdZhRow[] = DATA.map(
  ...
  return {
    ...
    rows,
    meta: {
      parser: "ustc_phd_zh_image_pdf_v1",
      doc_type: "ustc_phd_chinese_catalog_image_pdf",
      rows: rows.length,
      table_header: [
